...
class Boleto(models.Model):
    STATUS_CHOICES = (
        ...
        ('pago','Pago'),
        ('atrasado','Atrasado'),
        ('inadimplente','Inadimplete'),
        ('acordo','Acordo'),

    )
    # Informações Gerais
    status = models.CharField(max_length = 28, choices = STATUS_CHOICES, default = 'aberto' ) 
    unidade = models.CharField(max_length = 150, help_text = "Unidade docondomínio")
    codigo_banco = models.CharField('Código do Banco', max_length=5, default = '104', help_text = "Código do Banco")
    ...
    sacado_nome = models.CharField(u'Sacado', max_length=255)
    ...
    instrucoes = models.TextField(default=u"""1- Não receber após 20 dias.
